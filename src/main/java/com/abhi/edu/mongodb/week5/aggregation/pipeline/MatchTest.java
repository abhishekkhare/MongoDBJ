...
public class MatchTest {
	...
	public static void main(String[] args) {
		...
		/**
		 * db.movieDetails.aggregate([{$project:{title:1,genres:1,year:1}},{$match:{year:{$gt:2000}}}])
		 */
		{
		 ...
		 * db.movieDetails.aggregate([{$project:{title:1,genres:1,year:1,_id:0}},{$match:{year:{$gt:2000}}}])
		 * 
		 */
		{
		 ...
		 * db.movieDetails.aggregate([{$project:{title:1,_id:0,"tomato.userMeter":1,year:1}},{$match:{year:{$gt:2000}}}])
